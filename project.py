        ...
        while(len(self.events_queue) != 0):
            ...
            # Note neither type of switching uses process_num, switching in draws from the start of the queue
                ...
                if self.current_process == None:
                    ...
                    self.total_wait_time += current_time - self.processes[self.current_process].time_added - self.switch_time
                    print(current_time, self.processes[self.current_process].time_added)
                ...
                self.processes[process_num].time_added = current_time  # Used for calculating stats
                if self.current_process == None:
                    heappush(self.events_queue, (current_time+self.switch_time, "b_switch_in", process_num))
